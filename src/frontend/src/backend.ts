...
import type { Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, WaitlistEntry as _WaitlistEntry } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: string, arg1: string | null, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addEntry(arg0, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isOwnerSet(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isOwnerSet();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_WaitlistEntry_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WaitlistEntry): WaitlistEntry {
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WaitlistEntry>): Array<WaitlistEntry> {
    return value.map((x)=>from_candid_WaitlistEntry_n5(_uploadFile, _downloadFile, x));
}
